...
function getUserSummary(user: User): UserSummary {
  ...
  const avatarUrl = (typeof metadata.avatar_url === "string" && metadata.avatar_url) || (typeof metadata.profile_image_url === "string" && metadata.profile_image_url) || (typeof metadata.picture === "string" && metadata.picture) || null;
