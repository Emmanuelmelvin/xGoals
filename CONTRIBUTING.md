...
Thank you for helping make XGoals better. Contributions can include bug reports, design feedback, documentation, tests, accessibility improvements, and code.

## Before you begin

- Search the existing [issues](https://github.com/akinkunmi/xgoals/issues) and pull requests before opening a duplicate.
...
- Keep security vulnerabilities private. Email `security@xgoals.app` with reproduction details instead of opening a public issue.
- Follow the [Code of Conduct](CODE_OF_CONDUCT.md) in project spaces.

## Local setup

XGoals requires Node.js 22.12 or newer, pnpm, and Supabase.
...
3. Copy `.env.example` to `.env` and configure the required values:
   ...
   - AWS credentials (for AgentCore and Bedrock)
